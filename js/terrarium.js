$(document).ready(function() {
	...
	var addPlant = function(){ $.get("js/Animals/Plant.template.txt", function(result){ game.AddOrganismFromCode(result); }); };
	addPlant();
	...
	$("#load-herbie").click(function(){
		$.get("js/Animals/Herbie.template.txt", function(result){ editor.setValue(result); });
	});
	$("#load-carnie").click(function(){
		$.get("js/Animals/Carnie.template.txt", function(result){ editor.setValue(result); });
	});
